    ...
    <div style="padding-top: 10px; padding-left: 10px;">
    	<hr size="5" color="84BDF6">
     	...
     	<div style="margin-left: 100px;">
     		...
     		<tr><td>专　　　业:</td><td><input type="text" style="background: gray;" readonly="readonly" name="profession" id="profession" value="<s:property value='#request.profession'/>"/></td></tr>
