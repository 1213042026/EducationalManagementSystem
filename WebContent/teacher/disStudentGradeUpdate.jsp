	...
	<body bgcolor="EFF6FF">
		...
		<div style="padding-top: 10px; padding-left: 10px;">
			...
			<table border="1" bordercolor="gray">
				...
				<form action="teacherAction_studentGradeUpdateSubmit.action?sidnum=<s:property value="idnum" />&ggidnum=<s:property value="ggidnum" />"  method="post">
		...
		<tr>
			<td>&nbsp;<font style='color:#000000'> <a  href='teacherAction_studentGradeupdate.action?jumpPage=1'>首页</a>
		    </font> | <font style='color:#000000'> <a href="teacherAction_studentGradeupdate.action?jumpPage=<s:property value='#request.pageNow-1'/>">前页</a>
		    </font> | <font style='color:#000000'> <a href="teacherAction_studentGradeupdate.action?jumpPage=<s:property value='#request.pageNow+1'/>">后页</a>
		    </font> | <font style='color:#000000'> <a href="teacherAction_studentGradeupdate.action?jumpPage=<s:property value='#request.pageCount'/>">末页</a>
