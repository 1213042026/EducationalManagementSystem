	...
	<body bgcolor="EFF6FF">
		...
		<div style="padding-top: 10px; padding-left: 10px;">
			...
			<table border="1" bordercolor="gray">
				...
				<form action="teacherAction_studentCourseGradeInputSubmit.action?sidnum=<s:property value="idnum" />&ggidnum=<s:property value="ggidnum" />"  method="post">
...
href='teacherAction_studentCourseGradeInput.action?jumpPage=1'>首页</a>
		    </font> | <font style='color:#000000'> <a 

href="teacherAction_studentCourseGradeInput.action?jumpPage=<s:property 
