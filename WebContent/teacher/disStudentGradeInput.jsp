	...
	<body bgcolor="EFF6FF">
		...
		<div style="padding-top: 10px; padding-left: 10px;">
			...
			<table border="1" bordercolor="gray">
				...
				<form action="teacherAction_studentGradeInputSubmit.action?sidnum=<s:property value="idnum" />&ggidnum=<s:property value="ggidnum" />"  method="post">
					<tr style="color: 793AFF;">
			           ...
			           <td><input type="submit" onclick="" value="录入"/></td>
					</tr>
					</form>
					<tr>
		...
		<tr>
			<td>&nbsp;<font style='color:#000000'> <a  href='teacherAction_studentGradeInput.action?jumpPage=1'>首页</a>
		    </font> | <font style='color:#000000'> <a href="teacherAction_studentGradeInput.action?jumpPage=<s:property value='#request.pageNow-1'/>">前页</a>
		    </font> | <font style='color:#000000'> <a href="teacherAction_studentGradeInput.action?jumpPage=<s:property value='#request.pageNow+1'/>">后页</a>
		    </font> | <font style='color:#000000'> <a href="teacherAction_studentGradeInput.action?jumpPage=<s:property value='#request.pageCount'/>">末页</a>
