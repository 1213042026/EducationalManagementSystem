    ...
    <div style="padding-top: 10px; padding-left: 10px;">
    	<hr size="5" color="84BDF6">
     	...
     	<div style="margin-left: 100px;">
     		<form action="teacherAction_insertCourse.action" method="post">
     			<span>课程编号：</span><input type="text"  name="idnum" id="idnum" value="<s:property value='#request.maxIdnum' />" style="background: gray;"/><br/>
     			<span>课程名称：</span><input type="text" name="name" id="name"/><br/>
				...
				<option value="2">下学期</option>
						...
						<span>年	级：</span><input type="text" name="grade" id="grade"/><span style=" color: black;">如2008表示08级</span><br/>
						<br/>
					...
					<br/></br>
					<span>可选人数：</span><input type="text" name="kxPeople" id="kxPeople"><br/>
     			<span>备	注: </span><input type="text" name="remark" id="remark"><br/>
     			<br/>
