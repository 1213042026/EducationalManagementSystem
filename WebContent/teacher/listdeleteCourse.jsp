...
<script type="text/javascript">
		function deleteCourse( cidnum ){
		//alert(idnum);
			var truthBeTold = window.confirm("确定要删除此课程吗？"); 
			if (truthBeTold) { 
				location="teacherAction_disdeleteCourseButton.action?cidnum=" + cidnum;
			}
		}
	</script>
			...
			<table border="1" bordercolor="gray">
				...
				<s:iterator value="courseList">
					<tr style="color: 793AFF;">
					   ...
					   <td><input type="button" value="删除" onclick="deleteCourse('<s:property value="classId"/>')"/></td>
					</tr>
...
href='teacherAction_deleteAlreadyAddCourse.action?jumpPage=1'>首页</a>
		    </font> | <font style='color:#000000'> <a 

href="teacherAction_deleteAlreadyAddCourse.action?jumpPage=<s:property 
