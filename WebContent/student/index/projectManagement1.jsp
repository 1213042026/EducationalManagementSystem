...
a.files {
	...
	background:url(student/iconsIMG/fu_btn.gif) left top no-repeat;
  ...
  <table width="67%" border="0" align="center" cellspacing="1" class="fu_list">
    ...
    <tbody>
      <tr>
        ...
        <td><a href="javascript:void(0);" class="files" id="idFile"></a> <img id="idProcess" style="display:none;" src="student/iconsIMG/loading.gif" /></td>
      </tr>
      <tr>
