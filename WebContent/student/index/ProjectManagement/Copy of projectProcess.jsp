...
.STYLE1{
 ...
 font-size:17px;
	...
	function showDetail(idnum)
	{
		//alert();
		location="studentAction_showProjectDetail.action?idnum=" + idnum;
	}
	</script>
  </head>
 ...
 <div align="center"  class="STYLE1">查看毕业设计详情，请单击毕业设计名称，查看毕业设计的相关资料文档，请点击下载按钮</div>
	     <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1" align="center" >
	    	...
	    	<s:iterator value="graduationList">
		    	<tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand;font-size:14px'  title="" align="center">
		    		...
		    		<td ><font color="#000000" ><a onclick="showDetail('<s:property value="idnum"/>')"><s:property value="gname" />&nbsp;</a></font></td>
  ...
  <tr bgcolor='#D7E4F7'> 
	...
	<s:else>
		<table align="right" '100%' border='0' cellspacing='0' cellpadding='0' bgcolor='#D7E4F7'>
		<tr>
			<td>&nbsp;<font style='color:#000000'> <a  href='studentAction_index.action?jumpPage=1'>首页</a>
		    </font> | <font style='color:#000000'> <a href="studentAction_index.action?jumpPage=<s:property value='#request.pageNow-1'/>">前页</a>
		    </font> | <font style='color:#000000'> <a href="studentAction_index.action?jumpPage=<s:property value='#request.pageNow+1'/>">后页</a>
		    </font> | <font style='color:#000000'> <a href="studentAction_index.action?jumpPage=<s:property value='#request.pageCount'/>">末页</a>
		    </font> | <b><s:property value='#request.pageNow'/></b>页/<b><s:property value='#request.pageCount'/></b>页 | 共<b><s:property value='#request.maxRowCount'/></b>条记录
		</tr>
	</table>
	</s:else>
