...
<html>
  <head>
	...
	<script type="text/javascript">
		function display()
		{
			location="studentAction_listMyScore.action";
		}
  ...
  <tr>
    <td height="24" nowrap><font color="#FFFFFF"><img src="student/iconsIMG/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>当前位置：查询成绩</strong></font></td>
  </tr>
  <tr>
    <td align="center" nowrap  bgcolor="#EBF2F9">
	<form id="form1" name="form1" method="post" action="studentAction_indexScore">
...
<br />
	...
	<table align="right" '100%' border='0' cellspacing='0' cellpadding='0' bgcolor='#D7E4F7'>
		<tr>
			<td>&nbsp;<font style='color:#000000'> <a  href='studentAction_listMyScore.action?jumpPage=1'>首页</a>
		    </font> | <font style='color:#000000'> <a href="studentAction_listMyScore.action?jumpPage=<s:property value='#request.pageNow-1'/>">前页</a>
		    </font> | <font style='color:#000000'> <a href="studentAction_listMyScore.action?jumpPage=<s:property value='#request.pageNow+1'/>">后页</a>
		    </font> | <font style='color:#000000'> <a href="studentAction_listMyScore.action?jumpPage=<s:property value='#request.pageCount'/>">末页</a>
