...
<html>
  <head>
	...
	<script type="text/javascript">
		function deleteManager( idnum ){
			var truthBeTold = window.confirm("确定要删除此管理员吗？"); 
			if (truthBeTold) { 
				location="managerAction_deleteManager.action?idnum=" + idnum;
			}
		}
	</script>
  </head>
	    ...
	    <table>
	    	...
	    	<s:iterator value="managerList">
		    	<tr style="color: 793AFF; ">
		    		...
		    		<td><input type="button" value="删  除" onclick="deleteManager('<s:property value="idnum"/>')"/></td>
		    	</tr>
	    		<tr>
