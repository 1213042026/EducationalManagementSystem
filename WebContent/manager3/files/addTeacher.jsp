  ...
  <body bgcolor="EFF6FF">
    <div style="padding-top: 10px; padding-left: 10px;">
    	<hr size="5" color="84BDF6">
     	<center>
     		<div style="color: 793AFF; font-size: large"><b>添加教师</b></div>
     	</center>
     	<hr/>
     	<div style="margin-left: 100px;">
     		<form action="managerAction_insertTeacher.action" method="post">
     			<span>教师编号：</span><input type="text" readonly="readonly" name="idnum" id="idnum" value="<s:property value="#request.maxIdnum"/>" style="background: gray;"/><br/>
     			<span>教师姓名：</span><input type="text" name="name" id="name"/><br/>
     			<span>教师密码：</span><input class="password" type="password" name="password" id="password"><br/>
     			...
     			<span>学　　　历: </span><input type="text" name="scientific" id="scientific"><br/>
     			<span>职　　　称: </span><input type="text" name="title" id="title"><br/>
