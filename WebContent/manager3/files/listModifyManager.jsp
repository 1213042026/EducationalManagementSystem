...
<html>
  <head>
	...
	<script type="text/javascript">
		function modifyManager( idnum ){
			var truthBeTold = window.confirm("确定要修改此管理员吗？"); 
			if (truthBeTold) { 
				location="managerAction_getModifyManagerInfo.action?idnum=" + idnum;
			}
		}
	</script>
  </head>
	    ...
	    <table>
	    	...
	    	<s:iterator value="managerList">
		    	<tr style="color: 793AFF; ">
		    		...
		    		<td><input type="button" value="修  改" onclick="modifyManager('<s:property value="idnum"/>')"/></td>
		    	</tr>
	    		<tr>
