  ...
  <body bgcolor="EFF6FF">
    ...
    <div style="padding-top: 10px; padding-left: 10px;">
     <hr size="5" color="84BDF6">
		...
		<tr>
			<td>&nbsp;<font style='color:#000000'> <a  href='managerAction_listTeacher.action?jumpPage=1'>首页</a>
		    </font> | <font style='color:#000000'> <a href="managerAction_listTeacher.action?jumpPage=<s:property value='#request.pageNow-1'/>">前页</a>
		    </font> | <font style='color:#000000'> <a href="managerAction_listTeacher.action?jumpPage=<s:property value='#request.pageNow+1'/>">后页</a>
		    </font> | <font style='color:#000000'> <a href="managerAction_listTeacher.action?jumpPage=<s:property value='#request.pageCount'/>">末页</a>
