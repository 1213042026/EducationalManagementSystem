...
function validate(){
  ...
  <div  style="padding-top: 10px; padding-left: 10px;">
  	<hr size="5" color="84BDF6">
     	<center>
     		<div style="color: 793AFF; font-size: large"><b>修改密码</b></div>
     	</center>
     	<hr/>
  
 
  <form action="managerAction_updateManagerPersonPassword.action" method="post"  style="text-align: center;">
